...
let videouploadUrl = `${serverURLs[environment].ROOT_DIR}/solync/uploads`;

let uploadFolder = `${serverURLs[environment].ROOT_DIR}/solync/uploads/`;
let defualtImageUrl = `${serverURLs[environment].ROOT_DIR}/solync/uploads`;
let usersImageUrl = `${serverURLs[environment].ROOT_DIR}/solync/uploads/userImages/`;

let webUrlRoot = `${serverURLs[environment].NODE_SERVER}/solync/`;
let publicFolder = `${serverURLs[environment].NODE_SERVER}/public/`;

let DOCUMENT_ROOT=`${serverURLs[environment].ROOT_DIR}`;
let BASE_URL=`${serverURLs[environment].NODE_SERVER}/solync/`;
...
let solync_Multi_image_upload = (files, callback) => {
	let a = [];
