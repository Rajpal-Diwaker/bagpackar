...
$("#stay_home_form").on('submit',function(event){
var formStatus=true;
var address = $("#address").val();
var country = $("#country").val();
var city = $("#city").val();
...
$(".loaderCntr").show();
var data=[];
var data=$("#stay_home_form").serializeArray();
$.ajax({
url: "<?php echo base_url()?>admin/Admin/stay_home_process",
type: 'POST',
data:data,
success: function(response){
if(response ==1){
var notification = alertify.notify('Upload Successfully', 'success', 4, function(){ 
console.log('dismissed'); 
})
setTimeout(function() { 
window.location.href = '<?php echo base_url();?>admin/stay-home-list';
}, 500); 
}
if(response==0){
$(".loaderCntr").hide();
