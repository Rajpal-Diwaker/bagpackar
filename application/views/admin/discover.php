       ...
       <form method="post" enctype="multipart/form-data" id="discover_form">
        <div class="col-sm-9 col-lg-6 col-md-8 col-xs-12">
         ...
         <div class="user_profile_wrap clearfix ">
          <label for="">Discover Image</label>  
...
{ 
 ...
 $(".loaderCntr").show();
  ...
  $.ajax({
    url: "<?php echo base_url()?>admin/Admin/discover_process",
    type: 'POST',
    data:data,
    success: function(response){
      if(response ==1){
        ...
        setTimeout(function() { 
          window.location.href = '<?php echo base_url();?>admin/discover-list';
        }, 500); 
      }
      if(response==0){
       $(".loaderCntr").hide();
