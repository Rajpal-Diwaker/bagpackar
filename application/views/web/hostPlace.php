...
<div id="host_wrapper" class="hostform1">
    ...
    <span class="hostpname">Hi, <?php echo $_SESSION['webuser_bgpkr']['name'];?>! Let’s get started</span>
          ...
          <div class="form_group">
            ...
            <div class="select_tag">
              <select class="form-control" name="typeplace" id="typePlace" required>
                ...
                ?>
                <option value="<?=$value['place_type']?>" <?php if($value['place_type']==$plguest['place_type']){?> selected <?php }?>><?=$value['place_type']?></option>
                <?php } } ?>
              </select>
            ...
            <div class="select_tag">
              ...
              <option value="">Select Place type</option>
               <?php if($property){
                ...
                ?>
                <option value="<?=$value['property_type']?>"><?=$value['property_type']?></option>
                <?php } } ?>
            </select>
              <i class="fa fa-caret-down" aria-hidden="true"></i>
            </div>
        ...
        <div class="host_formdiv input_field">
          <div class="form_group">
            ...
            <select class="form-control" name="roomType" id="roomType" required>
                ...
                <option value="Whole area">Whole area</option>
          ...
          <div class="form_group">
            ...
            <div class="select_tag">
              <select class="form-control" name="dedicatedGuest" id="dedicatedGuest" required>
                ...
                <option value="Guest Entirely">Guest Entirely</option>
                <option value="Host Belongings">Host Belongings</option>
              </select>
              <i class="fa fa-caret-down" aria-hidden="true"></i>
            </div>
          ...
          <div class="form_group">
            ...
            <div class="select_tag">
              <select class="form-control" name="parkingType" id="parkingType" required>
                ...
                <option value="Dedicated parking area">Dedicated parking area</option>
                <option value="Front door parking">Front door parking</option>
                <option value="Garage">Garage</option>
                <option value="Roadside parking">Roadside parking</option>
              </select>
              <i class="fa fa-caret-down" aria-hidden="true"></i>
            </div>
      ...
      <!--host form2 end here-->
      <!--host form3 start here-->
      

      <!-- <div id="hostform3">
        <form id="vehicleData">
        <div class="host_formdiv input_field">
          <p>If you don't have any vehicle to add. You can Skip it.</p>
          <div class="form_group">
            <p>Vehicle Type</p>
            <div class="select_tag">
            ...
            <div id="vehicleType-error" class="form_error"></div>
          </div>
         <div class="form_group">
            <p>Vehicle Brand</p>
            <div class="select_tag">
            ...
            <div id="vehicleBrand-error" class="form_error"></div>
          </div>
          <div class="form_group">
            <p>Vehicle Model</p>
            <div class="select_tag">
            ...
            <div id="vehicleModel-error" class="form_error"></div>
          </div>
          <div class="form_group">
            <p>Vehicle Images</p>
           
          <div class="four_upload vehicle">
            <div class="img_ipload">
              <input type="file" onchange="createVehicleimg(this);" class="Vehicle_img" name="vehicle_img[]" id="vehicle_img1" accept="image/*" />
              <label for="vehicle_img1" class="uploadimgdiv">
            ...
            <div id="vehicle_img-error" class="form_error"></div>
          </div>
        <div class="form_group">
            <p>Vehicle Cost</p>
            <div class="cost_field">
        <input type="text" name="vehicleCost" id="vehicleCost" class="form-control" onkeypress="return isNumberKey(event)" placeholder="500">
         <i aria-hidden="true" class="fa fa-usd"></i>
            </div>
            <div id="vehicleCost-error" class="form_error"></div>
          </div>
        </div>
        <div class="host_formfooter">
          ...
          <span>
          <a href="javascript:void(0);" data-next="skipVehicle" class="btn_skip"> Skip <i class="fa fa-forward"></i></a>
          <a href="javascript:void(0);" class="btn_style" data-next="hostform4"> Next</a>
          </span>
        </div>
        </form>
      </div> -->
      ...
      <div class="number_input_box">
        <?php $guestC = !empty($plguest['guest'])?$plguest['guest']:1; ?>
        <div class="numbers_icon <?php if($guestC <= 1){?>svg_disable<?php } ?>" id="dGuest" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downGuest('guestPm','dGuest','min');">
      ...
      <div class="number_input_box">
        <div class="numbers_icon svg_disable" id="dbed" 
        ...
        <input type="number" name="noBedRoom" id="noBeds" min="1" value="1" max="100">
        <input type="hidden" id="bedPm" value="1">
        ...
        <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
          ...
          <div id="addBedsCount">       
         <div class="bedroom_count" id="mainId1">
        <div class="bedroomlabels">
        <span class="labels">
          Bedroom 1<span id="showText1">0 Beds</span>
        </span>
        <button type="button" class="actionbtn" id="btn1" onclick="addDiffbed('1','allbed1','btn1')"> Add Beds </button>
        <input type="hidden" class="totalbed" id="allbed1" value="0"/>
      </div>
       <div class="bedroom_count_div" id="bedroom_count_div1">
        <div class="form_group">
           ...
           <div class="incrementinput">
              ...
              <div class="number_input_box">
            <div class="numbers_icon svg_disable" id="king_inDis1" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('1','kingBedq1','king_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                ...
                <input type="hidden" id="kingBedq1" value="0">
                <div class="numbers_icon" onclick="this.parentNode.querySelector('input[type=number]').stepUp(); bedup('1','kingBedq1','king_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                    <rect height="12" rx="1" width="2" x="11" y="6"></rect>
            ...
            <div class="incrementinput">
              ...
              <div class="number_input_box">
              <div class="numbers_icon svg_disable" id="qb_inDis1" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('1','queenBedq1','qb_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                ...
                <input type="hidden" id="queenBedq1" value="0">
                <div class="numbers_icon" onclick="this.parentNode.querySelector('input[type=number]').stepUp(); bedup('1','queenBedq1','qb_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                    <rect height="12" rx="1" width="2" x="11" y="6"></rect>
            ...
            <div class="incrementinput">
              ...
              <div class="number_input_box">
            <div class="numbers_icon svg_disable" id="db_inDis1" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('1','doubleBedq1','db_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                ...
                <input type="hidden" id="doubleBedq1" value="0">
                <div class="numbers_icon" onclick="this.parentNode.querySelector('input[type=number]').stepUp(); bedup('1','doubleBedq1','db_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                    <rect height="12" rx="1" width="2" x="11" y="6"></rect>
            ...
            <div class="incrementinput">
              ...
              <div class="number_input_box">
                <div class="numbers_icon svg_disable" id="sb_inDis1" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('1','singleBedq1','sb_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                ...
                <input type="hidden" id="singleBedq1" value="0">
                <div class="numbers_icon" value="1" onclick="this.parentNode.querySelector('input[type=number]').stepUp(); bedup('1','singleBedq1','sb_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                    <rect height="12" rx="1" width="2" x="11" y="6"></rect>
           ...
           <div class="incrementinput">
              ...
              <div class="number_input_box">
            <div class="numbers_icon svg_disable" id="twin_inDis1" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('1','twinBedq1','twin_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                ...
                <input type="hidden" id="twinBedq1" value="0">
                <div class="numbers_icon" onclick="this.parentNode.querySelector('input[type=number]').stepUp(); bedup('1','twinBedq1','twin_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                    <rect height="12" rx="1" width="2" x="11" y="6"></rect>
           ...
           <div class="incrementinput">
              ...
              <div class="number_input_box">
          <div class="numbers_icon svg_disable" id="floor_inDis1" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('1','floorBedq1','floor_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                ...
                <input type="hidden" id="floorBedq1" value="0">
                <div class="numbers_icon" onclick="this.parentNode.querySelector('input[type=number]').stepUp(); bedup('1','floorBedq1','floor_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                    <rect height="12" rx="1" width="2" x="11" y="6"></rect>
           ...
           <div class="incrementinput">
              ...
              <div class="number_input_box">
              <div class="numbers_icon svg_disable" id="sob_inDis1" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('1','sofaBedq1','sob_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                ...
                <input type="hidden" id="sofaBedq1" value="0">
                <div class="numbers_icon" value="1" onclick="this.parentNode.querySelector('input[type=number]').stepUp(); bedup('1','sofaBedq1','sob_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                    <rect height="12" rx="1" width="2" x="11" y="6"></rect>
           ...
           <div class="incrementinput">
              ...
              <div class="number_input_box">
            <div class="numbers_icon svg_disable" id="air_inDis1" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('1','airBedq1','air_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                ...
                <input type="hidden" id="airBedq1" value="0">
                <div class="numbers_icon" onclick="this.parentNode.querySelector('input[type=number]').stepUp(); bedup('1','airBedq1','air_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                    <rect height="12" rx="1" width="2" x="11" y="6"></rect>
           ...
           <div class="incrementinput">
              ...
              <div class="number_input_box">
          <div class="numbers_icon svg_disable" id="couch_inDis1" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('1','couchBedq1','couch_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                ...
                <input type="hidden" id="couchBedq1" value="0">
                <div class="numbers_icon" onclick="this.parentNode.querySelector('input[type=number]').stepUp(); bedup('1','couchBedq1','couch_inDis1');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                    <rect height="12" rx="1" width="2" x="11" y="6"></rect>
        ...
        <div id="totalbed-error1" class="form_error"></div>
       </div>
...
<!-- Add these options to King, Queen, Full/Double, Twin, Floor Mattress, Sofa bed, Air Mattress, Couch. Add these section in "Other section" too -->

<div class="bedroom_count">
        <div class="bedroomlabels">
        <span class="labels">
          Comman Spaces<span id="showTextcommon">0 Bed</span>
        </span>
        <button type="button" class="actionbtn" id="btn_space" onclick="addDiffbed('common','allbedcommon','btn_space')"> Add Beds </button>
        <input type="hidden" id="allbedcommon" value="0"/>
      </div>
        ...
        <div class="form_group">
         <div class="form_group">
            ...
            <div class="incrementinput">
              <span class="labels">King Bed</span>
              <div class="number_input_box">
          <div class="numbers_icon svg_disable" id="king_inDisco" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('common','kingBedco','king_inDisco');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                </div>
                <input type="number" name="kingBedco" min="0" value="0" max="15">
                <input type="hidden" id="kingBedco" value="0">
          ...
          <div class="incrementinput">
              <span class="labels">Queen Bed</span>
              <div class="number_input_box">
              <div class="numbers_icon svg_disable" id="qb_inDisco" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('common','queenBedco','qb_inDisco');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                </div>
                <input type="number" name="queenBedco" min="0" value="0" max="15">
                <input type="hidden" id="queenBedco" value="0">
            ...
            <div class="incrementinput">
              <span class="labels">Full/Double Bed</span>
              <div class="number_input_box">
            <div class="numbers_icon svg_disable" id="db_inDisco" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('common','doubleBedco','db_inDisco');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                </div>
                <input type="number" name="doubleBedco" min="0" value="0" max="15">
                <input type="hidden" id="doubleBedco" value="0">
          ...
          <div class="incrementinput">
              <span class="labels">Twin Bed</span>
              <div class="number_input_box">
          <div class="numbers_icon svg_disable" id="twin_inDisco" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('common','twinBedco','twin_inDisco');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                </div>
                <input type="number" name="twinBedco" min="0" value="0" max="15">
                <input type="hidden" id="twinBedco" value="0">
           ...
           <div class="incrementinput">
              <span class="labels">Floor Mattress</span>
              <div class="number_input_box">
                <div class="numbers_icon svg_disable" id="flo_space" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('common','floorQuantity','flo_space');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                </div>
                <input type="number" name="floorQuantity" min="0" value="0" max="15">
                <input type="hidden" id="floorQuantity" value="0">
            ...
            <div class="incrementinput">
              <span class="labels">Sofa Bed</span>
              <div class="number_input_box">
                <div class="numbers_icon svg_disable" id="sob_space" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('common','sofaQuantity','sob_space');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                </div>
                <input type="number" name="sofaQuantity" min="0" value="0" max="15">
                 <input type="hidden" id="sofaQuantity" value="0">
           ...
           <div class="incrementinput">
              <span class="labels">Air Mattress</span>
              <div class="number_input_box">
          <div class="numbers_icon svg_disable" id="air_inDisco" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('common','airBedco','air_inDisco');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                </div>
                <input type="number" name="airBedco" min="0" value="0" max="15">
                <input type="hidden" id="airBedco" value="0">
            ...
            <div class="incrementinput">
              <span class="labels">Couch</span>
              <div class="number_input_box">
                <div class="numbers_icon svg_disable" id="co_space" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('common','couchQuantity','co_space');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
                </div>
                <input type="number" name="couchQuantity" min="0" value="0" max="15">
                <input type="hidden" id="couchQuantity" value="0">
      ...
      <div class="number_input_box">
        ...
        <input type="number" name="noOfBathroom" id="noOfBathroom" min="0" step="0.5" value="0.5">
        <input type="hidden" id="bathrPm" value="0.5">
    ...
    <span class="form_heading">Where is your place located?</span>
      ...
      <p>Street Address</p>
            <div class="location_input">
              <input type="text" name="location" id="location" class="form-control" placeholder="House name/No., street, road">
      ...
      <div class="form_group">
       <p>Tip:Drag the Pin and mark your place. This will help guests to 
             accurately locate your place.</p>
      </div>
          <input type="hidden" id="icon" value="<?php echo base_url();?>assets/images/pinicon.svg">
         <!--  <div class="form_group">
            <p>No of bedrooms guests can use</p>
            <div class="select_tag">
              <select class="form-control" name="guestsBedrooms" id="guestsBedrooms">
            ...
            <div id="guestsBedrooms-error" class="form_error"></div>
          </div> -->
          ...
          <!-- <div class="form_group">
            <p>Street Address</p>
            <input type="text" name="streetaddresss" id="streetaddresss" class="form-control" placeholder="House name/no+ Street/road">
            <div id="streetaddresss-error" class="form_error"></div>
          </div> -->

          <div class="form_group">
            <p>Apt, Suite.(optional)</p>
            <input type="text" name="apt" id="apt" class="form-control" placeholder="Apt, Suite.(optional)">
          ...
          <div class="form_group">
            <p>Zipcode</p>
            <input type="text" name="zipcode" id="zipcode" class="form-control" onkeypress="return isNumberKey(event)" placeholder="201301">
            ...
            <div class="select_tag">
              <select class="countries form-control" name="countryregion" id="countryId" required>
                ...
                <?php if ($countries) {
                  ...
                  <option value="<?=$valco['country_name'];?>"><?=$valco['country_name'];?></option>
               <?php 
             } } ?>
              </select>
              <i class="fa fa-caret-down" aria-hidden="true"></i>
        ...
        <div class="chekboxhost_formdiv input_field">
          ...
          <div class="checkboxwrapper">
           ...
           <?php if($kitchen_dining){
            ...
            <div class="checkboxdiv">
              <label for="<?=$value['name']?>">
                <input type="checkbox" name="kitchenDining[]" value="<?=$value['id']?>" id="<?=$value['name']?>">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
      ...
      <?php } } ?>
          ...
          <?php if($bedBaths){
            ...
            ?>
             <div class="checkboxdiv">
              <label for="<?=$value['name']?>">
                <input type="checkbox" name="bedBaths[]" value="<?=$value['id']?>" id="<?=$value['name']?>">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
        ...
        <span class="spanheading" id="entertainment">Entertainment Amenities</span>
          ...
          <?php if($entertainment){
            ...
            ?>
             <div class="checkboxdiv">
              <label for="<?=$value['name']?>">
                <input type="checkbox" name="entertainment[]" value="<?=$value['id']?>" id="<?=$value['name']?>">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
       ...
       <span class="spanheading" id="outside">Outside Amenities</span>
          ...
          <?php if($outside){
            ...
            ?>
             <div class="checkboxdiv">
              <label for="<?=$value['name']?>">
                <input type="checkbox" name="outside[]" value="<?=$value['id']?>" id="<?=$value['name']?>">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
        ...
        <span class="spanheading">Safety Amenities</span>
          <div class="safety_anemities">
            <div class="checkboxdiv">
              <label for="Smoke">
                <input type="checkbox" name="amenitiesSafty[]" value="57" id="Smoke">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
            ...
            <div class="checkboxdiv">
              <label for="first_aid">
                <input type="checkbox" name="amenitiesSafty[]" value="59" id="first_aid">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
            ...
            <div class="checkboxdiv">
              <label for="Carbon">
                <input type="checkbox" name="amenitiesSafty[]" value="58" id="Carbon">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
      ...
      <div class="otherAmenities_mainwr">
        <div class="otherAmenities_wr">
          <div class="otherAmenities_div">
            <input type="text" name="otherAmenities[]" class="form-control other" placeholder="Other Amenities">
          </div>
      ...
      <div id="other-error" class="form_error"></div>
        ...
        <p>Things to be taken care by guests.</p>
            <textarea name="place_rule" id="place_rule" cols="20" class="form-control" placeholder="Place Rules" rows="10" maxlength="1000"></textarea>
      ...
      <div id="hostform7">
        ...
        <div class="host_formdiv input_field">
          ...
          <div class="questuses">
            <div class="checkboxdiv">
              <label for="Kitchen">
                <input type="checkbox" name="guestSpaces[]" value="Kitchen" id="Kitchen">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
            ...
            <div class="checkboxdiv">
              <label for="washingmachine">
                <input type="checkbox" name="guestSpaces[]" value="Washingmachine" id="washingmachine">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
            ...
            <div class="checkboxdiv">
              <label for="dryer">
                <input type="checkbox" name="guestSpaces[]" value="Dryer" id="dryer">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
            ...
            <div class="checkboxdiv">
              <label for="Parking1">
                <input type="checkbox" name="guestSpaces[]" value="Parking" id="Parking1">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
            ...
            <div class="checkboxdiv">
              <label for="Gym1">
                <input type="checkbox" name="guestSpaces[]" value="Gym" id="Gym1">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
            ...
            <div class="checkboxdiv">
              <label for="Pool1">
                <input type="checkbox" name="guestSpaces[]" value="Pool" id="Pool1">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
            ...
            <div class="checkboxdiv">
              <label for="Hot1">
                <input type="checkbox" name="guestSpaces[]" value="Hot" id="Hot1">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
            ...
            <!-- <div class="checkboxdiv">
              <label for="tub1">
                <input type="checkbox" name="guestSpaces[]" value="Tub" id="tub1">
                <span>
                  <svg width="10.225" height="7.625" viewBox="0 0 10.225 7.625">
                    <path class="a"
                      d="M3.473,12.052.15,8.729a.511.511,0,0,1,0-.723l.723-.723a.511.511,0,0,1,.723,0L3.834,9.522,8.629,4.727a.511.511,0,0,1,.723,0l.723.723a.511.511,0,0,1,0,.723L4.2,12.052A.511.511,0,0,1,3.473,12.052Z"
    ...
    <a href="javascript:void(0);" data-next="skipImages" id="skipImages" class="btn_skip"> Skip <i class="fa fa-forward"></i></a>
        <div class="host_formdiv input_field">
          ...
          <div class="form_group">
            ...
            <div class="four_upload beds">
              <input type="hidden" name="bedchange" id="bedchange" value="notchange">
                <div class="img_ipload">
                <input type="file" name="bedroomImages[]" onchange="createimg(this);" id="Bedroomimg1" accept="image/*"/>
                <label for="Bedroomimg1" class="uploadimgdiv">
                  <i class="fa fa-picture-o" aria-hidden="true"></i>
                  <img src="" alt="">
                </label>
                <div class="img_upload_overlay">
          <span class="set_cover">
          <input type="radio" name="bedroomCover" onchange="changeSte('bedchange')" value="" id="bedcov1"  checked>
          <label for="bedcov1"><i class="fa fa-stop" aria-hidden="true"></i> <i class="fa fa-check-square-o" aria-hidden="true"></i> Set as cover</label>
          </span>
          <label for="Bedroomimg1" class="replaceImg"><i class="fa fa-refresh" aria-hidden="true"></i> Replace</label>
          ...
          <div class="form_group">
            ...
            <div class="four_upload bathrooms">
              ...
              <div class="img_ipload">
                <input type="file" name="bathsroomImages[]" onchange="createImgBath(this);" id="Bathroomimg1" accept="image/*" />
                <label for="Bathroomimg1" class="uploadimgdiv">
                  <i class="fa fa-picture-o" aria-hidden="true"></i>
                  <img src="" alt="">
                </label>
            <div class="img_upload_overlay">
            <span class="set_cover">
            <input type="radio" name="bathroomCover" value="0" id="bathcov1" onchange="changeSte('bathchange')" checked>
            <label for="bathcov1"><i class="fa fa-stop" aria-hidden="true"></i> <i class="fa fa-check-square-o" aria-hidden="true"></i> Set as cover</label>
            </span>
            <label for="Bathroomimg1" class="replaceImg"><i class="fa fa-refresh" aria-hidden="true"></i> Replace</label>
          ...
          <div class="form_group">
            ...
            <div class="four_upload kitchen">
              ...
              <div class="img_ipload">
                <input type="file" name="kitchenImages[]" onchange="createImgKit(this);" id="kitchen1" accept="image/*" />
                <label for="kitchen1" class="uploadimgdiv">
                  <i class="fa fa-picture-o" aria-hidden="true"></i>
                  <img src="" alt="">
                </label>
            <div class="img_upload_overlay">
            <span class="set_cover">
            <input type="radio" name="kitchenCover" value="0" id="kitchencov1" onchange="changeSte('kitchange')" checked>
            <label for="kitchencov1"><i class="fa fa-stop" aria-hidden="true"></i> <i class="fa fa-check-square-o" aria-hidden="true"></i> Set as cover</label>
            </span>
            <label for="kitchen1" class="replaceImg"><i class="fa fa-refresh" aria-hidden="true"></i> Replace</label>
        ...
        <div class="form_group">
            ...
            <div class="four_upload others">
              ...
              <div class="img_ipload">
                <input type="file" name="otherImages[]" onchange="createImgOther(this);" id="otherImg1" accept="image/*" />
                <label for="otherImg1" class="uploadimgdiv">
                  <i class="fa fa-picture-o" aria-hidden="true"></i>
                  <img src="" alt="">
                </label>
            <div class="img_upload_overlay">
            <span class="set_cover">
            <input type="radio" name="otherImgCover" value="" id="otherImgCover1" onchange="changeSte('otherchange')" checked>
            <label for="otherImgCover1"><i class="fa fa-stop" aria-hidden="true"></i> <i class="fa fa-check-square-o" aria-hidden="true"></i> Set as cover</label>
            </span>
            <label for="otherImg1" class="replaceImg"><i class="fa fa-refresh" aria-hidden="true"></i> Replace</label>
      ...
      <div id="hostform9">
        ...
        <div class="host_formdiv input_field">
          ...
          <div class="form_group">
          <input type="text" name="listingDescribe" id="listingDescribe" class="form-control" placeholder="Name of Listing" maxlength="50">
          <div id="listingDescribe-error" class="form_error"></div>
          </div>
          <div class="form_group">
            <textarea name="description" id="description" cols="20" class="form-control" placeholder="Description" rows="10" maxlength="25000"></textarea>
         ...
         <p>About Neighborhood</p>
          <div class="form_group">
            <textarea name="about_neighborhood" id="aboutNeighborhood" cols="20" class="form-control" placeholder="About Neighborhood" rows="10" maxlength="25000"></textarea>
      ...
      <div class="form_group">
          ...
          <div class="form_group">
            <p>Host name</p>
            <input type="text" name="hostname" id="hostname" class="form-control" placeholder="Name">
          ...
          <div class="form_group countrypickern">
            ...
            <div class="countrycodephone">
                <div class="phone_number_code_select countrycode">
                    <input id="country_code2" type="tel" class="form-control">
                </div>
                <div class="countryphone">
              <input type="text" name="otherphone" id="otherphone" class="form-control" placeholder="1234567890" onkeypress="return isNumberKey(event)">
                        </div>
      ...
      <div class="form_group">
          ...
          <div class="form_group">
           <p>About Hosts</p>
            <textarea name="intro" id="intro" cols="20" class="form-control" placeholder="Introduction" rows="10" maxlength="25000"></textarea>
      ...
      <div id="hostform11">
        ...
        <div class="host_formdiv input_field">
          ...
          <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="chilyes">
                  <input type="radio" name="suitableChild" value="1" id="chilyes">
                  <span>
          <svg x="0px" y="0px"
            ...
            <g>
              ...
              <div class="checkboxdiv">
                <label for="chilno">
                  <input type="radio" name="suitableChild" value="0" id="chilno">
                  <span>
          <svg x="0px" y="0px"
       ...
       <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="sinyes">
                  <input type="radio" name="suitableInfants" value="1" id="sinyes">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 512 512"  xml:space="preserve">
                       <g>
            <g>
              ...
              <div class="checkboxdiv">
                <label for="sinno">
                  <input type="radio" name="suitableInfants" value="0" id="sinno">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
          ...
          <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="spetyes">
                  <input type="radio" name="suitablePets" value="1" id="spetyes">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 512 512"  xml:space="preserve">
                  <g>
            <g>
              ...
              <div class="checkboxdiv">
                <label for="spetno">
                  <input type="radio" name="suitablePets" value="0" id="spetno">
                  <span>
                   <svg x="0px" y="0px"
             viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
          ...
          <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="smokeyes">
                  <input type="radio" name="allowSmoking" value="1" id="smokeyes">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 512 512"  xml:space="preserve">
                       <g>
            <g>
              ...
              <div class="checkboxdiv">
                <label for="smokeno">
                  <input type="radio" name="allowSmoking" value="0" id="smokeno">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
          ...
          <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="epyes">
                  <input type="radio" name="allowParties" value="1" id="epyes">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 512 512"  xml:space="preserve">
                       <g>
            <g>
              ...
              <div class="checkboxdiv">
                <label for="epno">
                  <input type="radio" name="allowParties" value="0" id="epno">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
          ...
          <!-- <div class="form_group">
          <p>Add More</p>
          <input type="text" name="addMore" id="addMore" class="form-control" placeholder="Add More">
          </div> -->
          <div class="form_group">
            <textarea name="addMore" id="addMore" cols="20" class="form-control" placeholder="Add More" rows="10" maxlength="1000"></textarea>
         </div>
      ...
      <div id="hostform12">
        ...
        <div class="host_formdiv input_field">
          ...
          <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="nsyes">
                  <input type="radio" name="noisePotential" value="1" id="nsyes">
                  <span>
                   <svg x="0px" y="0px"
             viewBox="0 0 512 512"  xml:space="preserve">
                       <g>
            <g>
              ...
              <div class="checkboxdiv">
                <label for="nsno">
                  <input type="radio" name="noisePotential" value="0" id="nsno">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
          ...
          <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="plpyes">
                  <input type="radio" name="petLive" value="1" id="plpyes">
                  <span>
                   <svg x="0px" y="0px"
             viewBox="0 0 512 512"  xml:space="preserve">
                       <g>
            <g>
              ...
              <div class="checkboxdiv">
                <label for="plpno">
                  <input type="radio" name="petLive" value="0" id="plpno">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
          ...
          <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="wpyes">
                  <input type="radio" name="haveWeapon" value="1" id="wpyes">
                  <span>
                   <svg x="0px" y="0px"
             viewBox="0 0 512 512"  xml:space="preserve">
                       <g>
            <g>
              ...
              <div class="checkboxdiv">
                <label for="wpno">
                  <input type="radio" name="haveWeapon" value="0" id="wpno">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
          ...
          <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="srdyes">
                  <input type="radio" name="mediaDevice" value="1" id="srdyes">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 512 512"  xml:space="preserve">
                       <g>
            <g>
              ...
              <div class="checkboxdiv">
                <label for="srdno">
                  <input type="radio" name="mediaDevice" value="0" id="srdno">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
          ...
          <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="olpyes">
                  <input type="radio" name="otherAnimal" value="1" id="olpyes">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 512 512"  xml:space="preserve">
                       <g>
              ...
              <div class="checkboxdiv">
                <label for="olpno">
                  <input type="radio" name="otherAnimal" value="0" id="olpno">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
        ...
        <!-- <div class="form_group">
          <p>If Any</p>
          <input type="text" name="ifany" id="ifany" class="form-control" placeholder="If Any Other">
            
       </div> -->
       <div class="form_group">
            <textarea name="ifany" id="ifany" cols="20" class="form-control" placeholder="If Any Other" rows="10" maxlength="1000"></textarea>
       </div>
          ...
          <div class="form_group">
            ...
            <div class="form_group">
              ...
              <select id="nightCount" class="form-control" name="nightMin" onchange="checkNightMinMax()" required>
                    <option value="" selected>Select Nights Minimum</option>
            ...
            <div class="form_group">
                ...
                <div class="select_tag">
                  <select id="dayCount" class="form-control" name="dayMin" onchange="checkNightMinMax()" required>
                   <option value="">Select Nights Maximum</option> 
                    <?php for($n=1;$n<91;$n++){
                    $night = $n>9?$n:'0'.$n; ?>
  ...
  for($mins=0; $mins<60; $mins+=30){ 
        ...
        <div class="form_group">
          <div class="flexdiv">
            ...
            <div class="checkboxwrapper">
              <div class="checkboxdiv">
                <label for="hdbyes">
                  <input type="radio" name="half_day_booking" value="1" id="hdbyes">
                  <span>
                   <svg x="0px" y="0px"
             viewBox="0 0 512 512"  xml:space="preserve">
                       <g>
            <g>
              ...
              <div class="checkboxdiv">
                <label for="hdbno">
                  <input type="radio" name="half_day_booking" value="0" id="hdbno">
                  <span>
                    <svg x="0px" y="0px"
             viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
      ...
      <div id="hostform15">
        ...
        <div class="host_formdiv input_field">
          ...
          <div class="form_group">
            <div class="cost_field">
              <input type="text" name="basePrice" id="basePrice" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Base Price">
          ...
          <div class="form_group" id="halfdayCheck">
            <div class="cost_field">
              <input type="text" name="halfDayPrice" id="halfDayPrice" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Half Day Price">
          ...
          <div class="flexdiv">
            <div class="form_group">
              <p class="nowrap">Min<small>*when there is low demand</small></p>
              <div class="cost_field">
              <input type="text" name="minPrice" id="minPrice" onkeypress="return isNumberKey(event)" class="form-control" placeholder="4500">
              <i aria-hidden="true" id="changeIcons2" class="fa fa-usd"></i>
              </div>
              <div id="minPrice-error" class="form_error"></div>
            </div>
            <div class="form_group">
              <p class="nowrap">Max<small>*when there is high demand</small></p>
              <div class="cost_field">
              <input type="text" name="maxprice" id="maxprice" onkeypress="return isNumberKey(event)" class="form-control" placeholder="8900">
          ...
          <div class="form_group">
            <div class="cost_field">
            <input type="text" name="cleanFee" id="cleanFee" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Cleaning Fee">
            <i aria-hidden="true" id="changeIcons4" class="fa fa-usd"></i>
            </div>
            <div id="cleanFee-error" class="form_error"></div>
          </div>
        <div class="form_group">
    <p>Tip:Please keep the cleaning fees to its actual price and as low as possible since most of the travelers find cleaning fees as an overhead. This can help your listing to get more bookings.</p>
    </div>
        </div>
        <div class="host_formfooter">
...
<p>Above mentioned details are the overview of some coverage under Proper Insurance. These insurance coverages may vary depending upon the homeowner’s property type. Please read all the details on the Proper Insurance’s website before proceeding further. Bagpackar is not responsible for resolving any conflicts between property owner and Proper Insurance. All Property owners, as of now, have the option to get their property covered through Proper Insurance. Bagpackar continue to work on getting homeowners property more secure and insured.</p>
      ...
      <input type="hidden" id="hostId" value="0">
    ...
    <div class="host_img" id="mapweb">
      <div id="hostmapwr">
         <!-- <p>Please set the pin in the Map
            You need to set the correct location of your listing since the address and the actual location of the listing may be slightly different. This will help guests to accurately locate your place.</p> -->
         <div id="hostmap">
  ...
  <!-- <div class="modal fade" id="mobverify" role="dialog" data-keybord="false" data-backdrop="static"> -->
 <div id="lsfmodal" class="modal otpopen" role="dialog">
   <div class="modal-dialog">
     <div class="modal-content">
...
$("#bedBaths-error" ).text( "Please select at least one Bed and Baths amenities." ).show().fadeOut( 5000 );
        ...
        if (otherImages.length > 0 && $('input[name="otherImgCover"]:checked').length == 0) {
         formStatus = false;
        ...
        $.ajax({
        //async: false,
        url: '<?php echo base_url('web/host/imagesBedBathKitchen'); ?>',
        type: 'POST',
        data: fd,
        contentType: false,
        processData: false,
        ...
        if($.isNumeric(business_phone) && business_phone != '' )
       {
        ...
        $.ajax({
        //async: false,
        url: '<?php echo base_url('web/host/hostAllDetail'); ?>',
        type: 'POST',
        data: fd,
        contentType: false,
        processData: false,
...
<!-- <script
  src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyAXhwY1oGHW8yJGpG7qjjpNda66L7Q_waA"></script> -->

  <!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB1hKM9oa_2BLZ0IMJIjq6H94PIoaDNuIU&libraries=places&callback=initAutocomplete" async defer></script> --> 
    ...
    geocoder.geocode({
        ...
        if (status == google.maps.GeocoderStatus.OK) {
            ...
            if (results[0]) {
                ...
                //map2 = new google.maps.Map(document.getElementById("hostmapmob"), myOptions);
...
function initAutocomplete() {
 ...
 <script type="">
              ...
              //   alert()
              //   $(this).parent().find('.bedroom_count_div').slideToggle();
              // })

             function addDiffbed(id,checkBeds,btnText){
                $('#bedroom_count_div'+id).slideToggle();
                //var gotId = $(this);
                // if($('#bedroom_count_div'+id).is(":visible") == true){
                //   //alert($(this).html())
                //   $(this).html('Done');
                // }else{
