...
<div id="host_wrapper" class="hostform1">
    <div class="host_formwr">
      ...
      <div class="number_input_box">
        <div class="numbers_icon" id="dGuest" 
        ...
        <input type="number" name="noGuest" id="noGuest" min="1" value="<?=$all_data['total_guest'];?>">
        <input type="hidden" id="guestPm" value="<?=$all_data['total_guest'];?>">
      ...
      <?php if ($all_data['total_bedrooms']) {
              ...
              $allCount = $doublebeds[$bd]+$queenbeds[$bd]+$singlebeds[$bd]+$sofabeds[$bd]+$kingbeds[$bd]+$twinbeds[$bd]+$floor_mattress[$bd]+$airbeds[$bd]+$couch[$bd];
...
<div class="bedroom_count">
        <?php  $allCountC = $all_data['total_sofa']+$all_data['total_couch']+$all_data['total_floor_mattress']+$all_data['total_kingbed']+$all_data['total_queenbed']+$all_data['total_doublebed']+$all_data['total_twinbed']+$all_data['total_airbed']; 
         ...
         <div class="form_group">
          ...
          <div class="incrementinput">
            ...
            <div class="incrementinput">
              <span class="labels">Full/Double Bed</span>
              <div class="number_input_box">
            <div class="numbers_icon <?php if($all_data['total_doublebed'] == 0){?>svg_disable<?php } ?>" id="db_inDisco" onclick="this.parentNode.querySelector('input[type=number]').stepDown(); downbed('common','doubleBedco','db_inDisco');">
                  <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false"
                    style="height: 22px; width: 22px; display: block; fill: currentcolor;">
                    <rect height="2" rx="1" width="12" x="6" y="11"></rect>
                  </svg>
      ...
      <div class="number_input_box">
        ...
        <input type="number" name="noOfBathroom" id="noOfBathroom" min="0" step="0.5" value="<?=$all_data['total_bathrooms'];?>">
        <input type="hidden" id="bathrPm" value="<?=$all_data['total_bathrooms'];?>">
    ...
    <span class="form_heading">Where is your place located?</span>
      ...
      <div class="host_formdiv input_field">
        ...
        <div class="otherAmenities_wr">
         ...
         for ($i=1; $i < count($otham); $i++) { ?>
          ...
          <div class="otherAmenities_btn amenitiesremovebtn"><i class="fa fa-times-circle" aria-hidden="true"></i>
          </div>
        </div>
      <?php } } ?>
      ...
      <div id="hostform8">
        ...
        <!--  yha loop chlega -->
          ...
          <?php $ik++; } } if(count($all_data['bedimage'])<7){ $count=count($all_data['bedimage'])+1; ?>
               ...
               <div class="img_ipload">
                ...
                <div class="img_upload_overlay">
          <span class="set_cover">
          <input type="radio" name="bedroomCover" value="" id="bedcov<?php echo $count;?>" onchange="changeSte('bedchange')">
        ...
        <?php $ik++; } } if(count($all_data['bathimage'])<7){ $count=count($all_data['bathimage'])+1; ?>
            ...
            <div class="img_upload_overlay">
            <span class="set_cover">
            <input type="radio" name="bathroomCover" value="" onchange="changeSte('bathchange')" id="bathcov<?php echo $count;?>">
        ...
        <div class="img_ipload">
            ...
            <div class="img_upload_overlay">
            <span class="set_cover">
            <input type="radio" name="kitchenCover" value="0" onchange="changeSte('kitchange')" id="kitchencov<?php echo $count;?>">
        ...
        <div class="form_group">
            ...
            <div class="img_upload_overlay">
            <span class="set_cover">
            <input type="radio" name="otherImgCover" value="" onchange="changeSte('otherchange')" id="otherImgCover<?php echo $count;?>">
        ...
        <input type="hidden" id="hostuserImg" name="hostuserImg" value="<?=$all_data['profile_img'];?>">
          ...
          <div class="form_group countrypickern">
            ...
            <div class="countrycodephone">
              ...
              <input type="text" name="primaryphone" id="primaryphone" value="<?=$all_data['primary_phone'];?>"  class="form-control" placeholder="1234567890" onkeypress="return isNumberKey(event)">
                        </div>
                      </div>
          ...
          <div class="form_group">
            ...
            <div class="four_upload">
             ...
             <?php $gvImg[1]=isset($gvImg[1])?$gvImg[1]:'';?>
              <div class="img_ipload img_uploadyes">
     ...
     <div class="form_group">
      ...
      <div id="hostform15">
        ...
        <div class="host_formdiv input_field">
          ...
          <div class="form_group">
            <div class="cost_field">
              <input type="text" name="basePrice" id="basePrice" value="<?=$all_data['base_price'];?>" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Base Price">
          ...
          <div class="flexdiv">
            <div class="form_group">
              ...
              <div class="cost_field">
              <input type="text" name="minPrice" id="minPrice" value="<?=$all_data['min_price'];?>" onkeypress="return isNumberKey(event)" class="form-control" placeholder="4500">
            ...
            <div class="form_group">
              ...
              <div class="cost_field">
              <input type="text" name="maxprice" id="maxprice" value="<?=$all_data['max_price'];?>" onkeypress="return isNumberKey(event)" class="form-control" placeholder="8900">
          ...
          <div class="form_group">
            <div class="cost_field">
            <input type="text" name="cleanFee" id="cleanFee" value="<?=$all_data['cleaning_fee'];?>" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Cleaning Fee">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <p>
            <span class="hostsubnote">Property updated successfully! </span>
            Admin will review & approve the property to be available again for the guest to book!
          </p>
...
<script>
 ...
 allowDropdown: true,
 autoPlaceholder: "off",
 initialCountry: "<?php echo $all_data['lang_code'];?>",
...
var halfdayVal = "<?php echo $all_data['half_day_price']?>";
    if (halfdayVal == '1') {
        $('#halfdayCheck').show();
    }
    else {
...
//         };
 ...
 <?php $curn='Dollar'; if ($this->session->userdata('country_lang_code')=='IN') {
      $curn='Rupees';
    }?>
<script>
